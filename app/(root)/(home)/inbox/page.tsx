...
const ExpertHelpChats = () => {
  ...
  const [currentUserMessageSent, setCurrentUserMessageSent] =
    ...
    const setSeen = async () => {
      try {
        ...
        if (userHelpChatsSnapshot.exists()) {
          ...
          console.log(
            "User help chats document does not exist for user",
            currentUser?._id
          );
        }
      } catch (error) {
  ...
  return (
    <div className="size-full h-[90vh] flex">
        ...
        {activeChats.chats.length > 0 && !chatId && (
          <div className="size-full">
            ...
            {activeChats.chats.map((chat: any, index: number) => (
              <div
                key={index}
                className={`flex items-center gap-2 transition duration-150 cursor-pointer rounded-lg p-4 ${
                  chat.chatId === chatId ? "border-2 bg-gray-100" : ""
                }`}
              ...
              >
                ...
                <div className="flex flex-col w-full">
                  ...
                  {/* Last Message */}
                  <span
                    className={`truncate max-w-[150px] overflow-hidden text-sm text-ellipsis whitespace-nowrap text-[#6B7280] ${
                      !chat.isSeen ? "font-bold text-black" : ""
                    }`}
                  >
                    {chat.lastMessage}
                  </span>
        ...
        {chatId && (
          ...
          >
            ...
            <div className="h-full">
                          ...
                          (message: Messages, index: number) => {
                            ...
                            const isNextMessageDifferentSender =
                              ...
                              chat.messages[index + 1].senderId !==
                                message.senderId;
                            const marginBottom = isNextMessageDifferentSender
                              ? "mb-3"
                              : "mb-1";
              ...
              <div className="fixed bg-gray-100 bottom-0 w-full z-30 bg-cover bg-center p-safe-bottom md:hidden">
      ...
      <div className="hidden md:flex items-center justify-center p-6 pt-0 bg-gray-100 w-full h-full">
        {chatId && (
          <div className="md:w-[98%] lg:w-[98%] h-[98%] md:flex flex-col rounded-md bg-cover bg-center">
        ...
        {!chatId && (
          <div className="flex items-center justify-center flex-col">
            ...
            <span className="text-lg font-semibold mb-1">Your Messages</span>
