...
const UsersTable: React.FC = () => {
  ...
  const {
    ...
    isError,
    isLoading,
  } = useGetUniqueClients(currentUser?._id as string, dateFilter, statusFilter);
    ...
    <div className="p-8">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <Button
          ...
          className="bg-[#16A34A] flex items-center gap-2 rounded-full text-white"
        >
      ...
      <div className="flex border rounded-lg p-6 gap-4 mb-8 w-full">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline"
              className="flex-1 flex justify-between rounded-none"
            >
          ...
          <tbody>
            {isLoading ? (
                ...
                <td colSpan={7} className="py-16 text-center align-middle">
                  ...
                  <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <p className="text-sm text-gray-500 max-w-md">
                      There are no users yet. Once you start your consultation
                      you will see your user details here.
                    </p>
                  </div>
                </td>
              </tr>
              ...
              filteredClients.map((client, index) => (
                <tr
                  key={index}
                  className="border-b last:border-b-0 text-sm text-[#6B7280] hover:bg-gray-50 cursor-pointer"
                  onClick={() =>
                    handleClick(client.clientDetails?._id as string)
                  }
                >
                  {/* Patient */}
                  ...
                  {/* Service */}
                  <td className="px-6 py-4">
                    {formatDuration(Number(client?.duration)) || "-"}
                  </td>
                  {/* Type */}
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1">
                      ...
                      >
                        <defs>
                          <clipPath id="master_svg0_142_7976">
                            <rect
                              x="0"
                              y="0"
                              width="16.75"
                        ...
                        <g clip-path="url(#master_svg0_142_7976)">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-3 items-center justify-center">
                      <button>
                        ...
                        >
                          <defs>
                            <clipPath id="master_svg0_142_7962">
                              <rect
                                x="0"
                                y="0"
                                width="12.25"
                      ...
                      <button>
                        ...
                        >
                          <defs>
                            <clipPath id="master_svg0_142_7966">
                              <rect
                                x="0"
                                y="0"
                                width="15.75"
                      ...
                      <button>
                        ...
                        >
                          <defs>
                            <clipPath id="master_svg0_142_7970">
                              <rect
                                x="0"
                                y="0"
                                width="12.25"
                          ...
                          <g clip-path="url(#master_svg0_142_7970)">
      ...
      {!hasNextPage &&
        !isFetchingNextPage &&
        clientsData?.pages[0]?.clients.length >= 1 && (
