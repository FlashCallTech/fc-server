...
import { backendBaseUrl, formatDateTime, frontendBaseUrl } from "@/lib/utils";
			...
			<div className="size-full flex bg-white">
				<div className="w-full p-8">
					...
					<section className="bg-white mb-8 border-[1px] rounded-lg p-6 shadow-sm">
						...
						Get ₹{referralSettings?.amount} for each successful referral when your friend completes their first transaction.
						</span>
