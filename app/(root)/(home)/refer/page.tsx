...
const ReferralLink: React.FC = () => {
  ...
  return (
    <div className="bg-gray-100 h-full w-full flex flex-col gap-2 font-helvetica">
      <div className="p-4 bg-gray-100 h-full w-full flex flex-col gap-2 font-helvetica">
        {/* Header */}
        ...
        <div className="bg-green-600 text-white p-4 rounded-lg flex flex-row items-center justify-between">
          ...
          <div className="flex flex-row gap-1 justify-between">
            ...
            <div className="bg-green-800 px-1 rounded-full justify-center">
              <button onClick={handleShare}>
                <Image src={'/send.svg'} width={0} height={0} alt="share" className="w-[45px] h-[10px]" />
              </button>
            </div>
          </div>
        </div>
                ...
                return (
                  <li key={index} className="bg-white p-4 rounded-lg shadow-md">
                    <div className="flex flex-row items-center gap-5">
                      <div>
                        <Image src={"https://firebasestorage.googleapis.com/v0/b/flashcallchat.appspot.com/o/assets%2FM_preview.png?alt=media&token=750fc704-c540-4843-9cbd-bfc4609780e0"} width={0} height={0} alt="image" className="w-[39px] h-[33px] rounded-full" />
                      </div>
