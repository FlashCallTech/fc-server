...
const SignoutAlert = () => {
	...
	const handleSignoutUser = async () => {
		...
		try {
			...
			router.replace(storedURL ? `${storedURL}` : "/");
		} catch (error) {
	...
	return (
		<>
			...
			<button
				className={`text-red-500 flex items-center justify-center gap-2 hoverScaleDownEffect border-none outline-none ${
					userType === "client" && "pl-4"
				}`}
