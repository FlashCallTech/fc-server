...
const DeleteAlert = () => {
	...
	return (
		<div className="flex justify-center items-center w-fit flex-col gap-7 text-black ">
			...
			<button
				className="text-white flex items-center justify-center gap-2 hoverScaleDownEffect bg-red-500 rounded-full px-4 py-2"
			...
			>
				...
				<span className="hidden xl:block text-sm text-nowrap">
					Delete Account
				</span>
			</button>
			{isMobileView ? (
