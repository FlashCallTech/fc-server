      ...
      <div className="hidden lg:flex size-full flex-col items-start text-base justify-start p-8">
        <div className="flex flex-col gap-6 h-full w-[60%]">
          ...
          <div className="rounded-md p-4 bg-white border">
            <label
              htmlFor="pan"
              className={`flex flex-row justify-between items-center text-sm font-bold rounded-md p-3 bg-white ${
                panVerified ? "" : "hover:cursor-pointer"
              }`}
              onClick={handleLabelClick}
            >
              ...
              <div className="flex flex-row gap-2 items-center">
                <Image
                  ...
                  className={`size-4 ${
                    panVerified
                      ? ""
                      : "filter grayscale brightness-[0.7] sepia hue-rotate-[220deg]"
                  }`}
                  onContextMenu={(e) => e.preventDefault()}
                />
                <Image
            ...
            {panVerified ? (
              <div className="p-2 flex flex-col text-sm text-gray-400">
                <span>
                  Pan Number:{" "}
                  <span className="text-black font-bold">{panNumber}</span>{" "}
                </span>
                <span>
                  Status: <span className="text-[#16BC88]">Verified</span>
                </span>
              </div>
            ) : (
              <div className="flex flex-col gap-3 pl-8">
                ...
                {isPanInputVisible && (
                  <span className="text-sm text-[#6B7280] font-normal leading-6">
                    Format: ABCDE1234F
                  </span>
                )}
          ...
          <div className="rounded-md p-4 bg-white border">
            <label
              htmlFor="aadhaar"
              className={`flex flex-row justify-between items-center text-sm font-bold rounded-md p-3 bg-white ${
                aadhaarVerified ? "" : "hover:cursor-pointer"
              }`}
              onClick={handleAadhaarLabelClick}
            >
              <div className="flex gap-3 items-center">
                <Image
                  src={"/creator/aadhaar.svg"}
                  width={100}
                  height={100}
                  alt="pan"
                  className="size-4"
              ...
              <div className="p-2 flex flex-col text-sm text-gray-400">
                <span>
                  ...
                  <span className="text-black font-bold">
                    {formatMaskedString(aadhaarNumber)}
                  </span>{" "}
                </span>
                <span>
                  Status: <span className="text-[#16BC88]">Verified</span>
          ...
          <div className="rounded-md p-4 bg-white border">
            <label
              htmlFor="liveliness_check"
              className={`flex flex-row justify-between items-center text-sm font-bold rounded-md p-3 bg-white ${
                livelinessCheckVerified ? "" : "hover:cursor-pointer"
              }`}
              onClick={handleLivelinessCheckLabelClick}
            >
              <div className="flex gap-3 items-center">
              ...
              <div className="flex flex-row gap-2 items-center">
                ...
                <Image
                  ...
                  alt="drop down"
                  className={`w-[3vh] h-[3vh] ${
                    livelinessCheckVerified ? "hidden" : ""
                  }`}
                  onContextMenu={(e) => e.preventDefault()}
                />
              </div>
            ...
            {livelinessCheckVerified ? (
              <div className="p-2 text-sm text-gray-400">
                <span>Status: </span>
                <span className="text-[#16BC88]">Verified</span>
              </div>
            ) : (
              isLivelinessCheckInputVisible && (
                <div className="flex flex-col gap-3 justify-center items-center">
                        ...
                        !livelinessCheckVerified && (
                          <Button
                            className={`flex items-center gap-2 ${
                              !livelinessCheckFile ? "hoverScaleDownEffect" : ""
                            } text-white rounded-full bg-black`}
                            onClick={handleLivelinessVerification}
                            disabled={
                              verifyingLiveliness ||
                              livelinessCheckFile === null
                            }
                          >
                            {!verifyingLiveliness && (
                              <Image
                            ...
                            <span>
                              {verifyingLiveliness ? "Verifying..." : "Submit"}
                            </span>
                          </Button>
                        )}
                    </div>
                  ...
                  <span className="text-[#4B5563] text-sm">
                    Please ensure you&apos;re in a well-lit area and your face
                    is clearly visible
                  </span>
                </div>
              )
                  ...
                  <div>
                    ...
                    <p>
                      <span className="text-[13px]">{`${
                        reason === nameMismatchCheck
                          ? "The name on your Aadhaar card and Pan card doesn't match with the provided information. Our verification team will contact you within 24 hours to resolve this issue."
                          : "The face on your Aadhaar card and Liveliness Photo doesn't match with the provided information. Our verification team will contact you within 24 hours to resolve this issue."
                      }`}</span>
                    </p>
                  </div>
                </section>
