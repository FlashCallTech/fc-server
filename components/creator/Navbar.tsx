...
const CreatorNavbar = ({ isMobile }: { isMobile?: boolean }) => {
    ...
    const isCreatorHome = pathname.includes("home") && userType === "creator" && currentUser;
    ...
    const pageName = () => {
        ...
        else if (pathname.includes("terms-and-conditions")) return "Terms and Conditions";
                    ...
                    >
                        ...
                        >
                            <path
                                ...
                                fill="currentColor"
                            />
                            <path d="M15 8V11H12.5C11.6715 11 11 10.3285 11 9.5C11 8.6715 11.6715 8 12.5 8H15Z" fill="currentColor" />
                        </svg>
