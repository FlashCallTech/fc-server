    ...
    <div className="flex flex-col h-full items-center justify-center rounded-xl p-4 w-full min-h-[300px] transition-all duration-300 shadow-md border border-gray-200 bg-white sm:min-h-[250px] md:p-5 lg:p-6 hover:bg-gray-50">
      <div className="flex flex-col flex-1 w-full items-start justify-between">
        ...
        <div className="w-full flex items-center justify-between gap-4">
          ...
          <div
            className={`text-xs rounded-full font-medium h-[28px] px-3 flex items-center justify-center whitespace-nowrap ${
              status === "Online"
        ...
        <div className="flex items-center justify-start gap-2 mt-2 text-gray-600 w-full">
          {rating > 0 ? (
            ...
            <div
              className={`text-xs rounded-full font-medium h-[28px] px-3 flex items-center justify-center whitespace-nowrap bg-[#FFEDD5] text-[#9A3412]`}
            >
              New Consultant
            </div>
          )}
