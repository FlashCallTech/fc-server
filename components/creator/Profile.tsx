  ...
  return (
    <div className='flex flex-col min-h-screen bg-gray-50'>
      ...
      <div className='flex p-4 flex-col gap-4'>
        ...
        <div className='flex flex-row rounded-xl border p-4 bg-white shadow-sm'>KYC</div>
        <div className='flex flex-row rounded-xl border p-4 bg-white shadow-sm'>Support</div>
        <div className='flex flex-row rounded-xl border p-4 bg-white shadow-sm'>Payment Settings</div>
        <div className='flex flex-row rounded-xl border p-4 bg-white shadow-sm'>Terms & Condition</div>
        <div className='flex flex-row rounded-xl border p-4 bg-white shadow-sm'>Logout</div>
      </div>
