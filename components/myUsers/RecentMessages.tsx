            ...
            <div className="border rounded-lg text-sm">
                {latestMessages.length > 0 ? (
                    latestMessages.map((message, index) => {
                        ...
                        const senderImg = isClient ? helpChatData.clientImg : helpChatData.creatorImg;
                        const senderName = isClient ? helpChatData.clientName : helpChatData.creatorName;
                        return (
                            <div key={index} className={`flex items-start px-4 py-3 ${index !== 2 && "border-b"} space-x-3`}>
                                ...
                                <div>
                                    <p className="font-semibold">{message.senderId === creatorId ? "You" : senderName}</p>
