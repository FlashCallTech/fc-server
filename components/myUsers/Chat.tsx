...
const Chat: React.FC<Props> = ({ clientId, creatorId }) => {
        ...
        userIDs.map(async (id: string) => {
          ...
          if (userHelpChatsSnapshot.exists()) {
            ...
            if (chatIndex !== -1) {
              ...
              console.warn(
                `Chat with chatId ${chat?.chatId} not found for user ${id}`
              );
            }
          }
        })
  ...
  return (
    <div className="flex flex-col p-6">
      {/* Header Section */}
      {chat && <h2 className="text-lg font-semibold mb-6">Messages</h2>}
      {chat?.chatId && (
        <div className="w-[98%] h-[98%] rounded-lg border p-4">
