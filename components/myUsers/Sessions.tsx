                    ...
                    <DropdownMenu>
                        ...
                        >
                            ...
                            <DropdownMenuItem
                                ...
                                className={`${filter === "All Types" ? "font-semibold cursor-default" : "hover:bg-gray-100 cursor-pointer"
                            ...
                            <DropdownMenuItem
                                ...
                                className={`${filter === "Completed" ? "font-semibold cursor-default" : "hover:bg-gray-100 cursor-pointer"
                                    } text-gray-700 text-sm px-4 py-2 focus:outline-none`}
                            >
                                Completed
                            </DropdownMenuItem>
                            ...
                            <DropdownMenuItem
                                ...
                                className={`${filter === "Cancelled" ? "font-semibold cursor-default" : "hover:bg-gray-100 cursor-pointer"
                                    } text-gray-700 text-sm px-4 py-2 focus:outline-none`}
                            >
                                Cancelled
                            </DropdownMenuItem>
                            ...
                            <DropdownMenuItem
                                ...
                                className={`${filter === "Initiated" ? "font-semibold cursor-default" : "hover:bg-gray-100 cursor-pointer"
                                    } text-gray-700 text-sm px-4 py-2 focus:outline-none`}
                            >
                                Initiated
                            </DropdownMenuItem>
                            ...
                            <DropdownMenuItem
                                ...
                                className={`${filter === "Scheduled" ? "font-semibold cursor-default" : "hover:bg-gray-100 cursor-pointer"
                                    } text-gray-700 text-sm px-4 py-2 focus:outline-none`}
                            >
                                Scheduled
                            </DropdownMenuItem>
                        ...
                        >
                            <DropdownMenuItem
                                ...
                                className={`${sort === "Descending" ?
                                    ...
                                    "hover:bg-gray-100 cursor-pointer"} text-gray-700 text-sm px-4 py-2 focus:outline-none `}                            >
                                Descending
                            </DropdownMenuItem>
                            <DropdownMenuItem
                                onClick={() => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                <div className={`flex items-center justify-center rounded-lg size-10 ${statusClasses}`}>
                                    {getSessionIcon(session.type)}
                                </div>
                                <div>
                                    <p className="font-semibold text-sm">{getSessionTitle(session)}</p>
                                    <p className="text-xs text-gray-500">
                                        {formattedDate} {session.status === "Ended" && ` • ${formatDuration(session.duration)}`}
                                    </p>
                                </div>
                            </div>
                            {/* Right: Status Badge */}
                            <span className={`text-xs font-semibold px-2 py-1 rounded-full ${statusClasses}`}>
                                {session.status === "Ended" ? "Completed" : session.status === "Canceled" ? "Cancelled" : session.status === "cancelled" ? "Cancelled" : session.status}
                            </span>
                        </div>
                    );
                })}
