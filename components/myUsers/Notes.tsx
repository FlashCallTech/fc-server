                        ...
                        page?.notes?.map((note: Note) => {
                            return (
                                ...
                                >
                                    ...
                                    {/* Main Note Text */}
                                    <p className="text-[#374151] text-[13px] text-medium">{note.text}</p>
