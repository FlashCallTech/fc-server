			...
			<div className="lg:hidden flex items-center justify-start w-full">
				<div className="flex flex-col gap-2 items-start justify-center w-full">
					...
					<div className="pl-1 flex flex-col items-start justify-start gap-2 w-full h-full overflow-scroll no-scrollbar">
						<span
							className={`no-scrollbar pl-1 ${isExpanded
			...
			<div className="hidden lg:flex items-center justify-start w-full">
				<div className="flex flex-col gap-2 items-start justify-center w-full">
					<Rating
						...
						readOnly
					/>
					<div className="flex items-center justify-between gap-2 w-full h-full overflow-scroll no-scrollbar">
						<span
							className={`no-scrollbar text-base ml-1 text-[#374151] ${isExpanded
								? "whitespace-pre-wrap overflow-x-hidden max-h-[150px]"
								: "text-ellipsis whitespace-nowrap overflow-x-hidden max-w-[95%]"
								}`}
						>
						...
						<div className="flex items-center justify-start gap-2">
							<div className="flex items-center justify-start gap-2">
								...
								<span className="text-sm">{feedback?.clientId?.username}</span>
							</div>
