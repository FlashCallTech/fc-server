...
const ChatInterface: React.FC = () => {
	...
	return (
		<div className={`flex flex-col justify-between w-screen bg-cover bg-center overflow-y-auto scrollbar-hide`} style={{ backgroundImage: 'url(/back.png)', height: "calc(var(--vh, 1vh) * 100)" } } >
