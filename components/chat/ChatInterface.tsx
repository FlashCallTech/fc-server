...
const ChatInterface: React.FC = () => {
	...
	return (
		<div className={`flex flex-col justify-between h-screen-dynamic w-screen bg-cover bg-center overflow-y-auto scrollbar-hide`} style={{ backgroundImage: 'url(/back.png)' }} >
