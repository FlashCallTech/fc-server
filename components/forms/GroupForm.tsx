		...
		>
			...
			<div className="mt-5 w-full flex flex-col items-start justify-start gap-4">
				<div className="w-full flex justify-between items-center">
					<label className="block text-lg font-semibold">Behavior Rules</label>
					<Button
						type="button"
						onClick={() =>
				...
				{errors.behaviorRules && (
					<p className="text-red-500 text-sm">{errors.behaviorRules.message}</p>
				)}
			</div>
			...
			{/* Submit */}
			<div className="mt-auto sticky bottom-0 right-0 py-2.5 w-full flex justify-end gap-2.5 bg-white">
				<Button
					variant="ghost"
