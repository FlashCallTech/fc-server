...
const ServicePreview = ({
	...
	return (
		<div
			className={`w-full flex flex-col p-4 border border-gray-300 rounded-[24px] min-h-[52px] gap-3 justify-between items-start w-full`}
		>
			<div className="w-full flex flex-col items-start xl:items-end justify-between gap-2">
				<div className="w-full flex flex-col items-start justify-center xl:gap-2">
					...
					{isExpanded && (
						<button
							onClick={() => toggleReadMore()}
							className="text-sm font-semibold hoverScaleDownEffect"
						>
							Show Less
						</button>
					)}
				...
				<div className="w-full flex items-center justify-center p-2 pl-3 cursor-pointer border-2 border-gray-300 rounded-full">
